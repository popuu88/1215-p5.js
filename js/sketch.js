...
function setup() {
  ...
  //load
  sprite_flappy = loadImage('/data/flappybird.png');
  sprite_pipe = loadImage('/data/pipe.png');
  sprite_city = loadImage('/data/city.png');
  sprite_floor = loadImage('/data/floor.png');
  sprite_title = loadImage('/data/title.png');
  
  
  sound_point = loadSound('/data/sfx_point.wav');
  sound_hit = loadSound('/data/sfx_hit.wav');
  sound_die = loadSound('/data/sfx_die.wav');
  //sound_wing = loadSound('http://flappybird.netlify.com/data/Assets/sound/sfx_wing.wav');
  sound_wing = loadSound('/data/sfx_wing.wav');
  sound_sweetwing = loadSound('/data/sfx_swooshing.wav');
  
  
  font_flappy = loadFont('/data/flappy-font.ttf');
